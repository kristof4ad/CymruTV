...
//  var coordinate: CLLocationCoordinate2D
  ...
  init(title: String?, summary: String? = nil, fullDescription: String? = nil, imageName: String? = nil) {
    self.title = title
